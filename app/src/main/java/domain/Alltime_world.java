...
public class Alltime_world {
    ...
    public Alltime_world() {
    }

    public Alltime_world(Integer id, Date date, String name, Integer total_confirm, Integer total_dead, Integer total_heal, Integer present_confirm) {
        this.id = id;
        this.date = date;
        this.name = name;
