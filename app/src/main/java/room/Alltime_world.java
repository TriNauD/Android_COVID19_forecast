...
public class Alltime_world {
    ...
    private String name;
    @ColumnInfo(name="total_confirm")
    private Integer total_confirm;
    @ColumnInfo(name="total_dead")
    private Integer total_dead;
    @ColumnInfo(name="total_heal")
    private Integer total_heal;
    @ColumnInfo(name="present_confirm")
    private Integer present_confirm;

    public Alltime_world(Date date, String name, Integer total_confirm, Integer total_dead, Integer total_heal, Integer present_confirm) {
        this.date = date;
        this.name = name;
